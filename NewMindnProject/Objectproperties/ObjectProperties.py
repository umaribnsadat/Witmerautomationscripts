...
class ObjectRepository:
    ...
    #login_url = "https://testapp.witmer.ai/"

    # Locators
    login_email_name = (By.NAME, "email")
    login_password_name = (By.NAME, "password")
    login_button_css = (By.CSS_SELECTOR, ".btn.text-uppercase.login-new-btn")

    # Login Credentials
    login_email = 'umarhussain4046@gmail.com'
    login_password = 'Dellm3800$'
    #login_email = "sivagamisrinivasan1@gmail.com"
    #login_password = "Bojo1998*"
